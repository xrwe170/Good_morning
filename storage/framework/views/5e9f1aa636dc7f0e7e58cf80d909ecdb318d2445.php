        ...
        <form class="layui-form col-lg-5">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="account" autocomplete="off" class="layui-input layui-disabled" value="<?php echo e($results['account']); ?>" placeholder="" disabled>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">钱包币种</label>
                <div class="layui-input-block">
                    <input type="text" name="currency" autocomplete="off" class="layui-input layui-disabled" value="<?php echo e($results['currency_name']); ?>" placeholder="" disabled>
                </div>
            </div>
            <div class="layui-form-item">
    ...
    <script type="text/javascript">
        ...
        layui.use(['form','upload','layer'], function () {
            ...
            form.on('submit(user_submit)', function (data) {
                ...
                console.log(data)
                $.ajax({
                    url:'<?php echo e(url('admin/user/conf')); ?>',
                    type: 'post',
                    dataType: 'json',
                    data: data,
