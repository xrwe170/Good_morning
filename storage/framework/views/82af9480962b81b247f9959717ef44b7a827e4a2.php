  ...
  <div class="layui-row layui-col-space15">
        ...
        <div class="layui-col-sm6 layui-col-md4">
          <div class="layui-card">
            ...
            <div class="layui-card-body layuiadmin-card-list">
              <p class="layuiadmin-big-font"><?php echo e($settlement); ?></p>
        ...
        <div class="layui-col-sm6 layui-col-md4">
          <div class="layui-card">
            ...
            <div class="layui-card-body layuiadmin-card-list">
              <p class="layuiadmin-big-font"><?php echo e($subordinate_agent_num); ?></p>
        ...
        <div class="layui-col-sm6 layui-col-md4">
          <div class="layui-card">
            ...
            <div class="layui-card-body layuiadmin-card-list">
              <p class="layuiadmin-big-font"><?php echo e($subordinate_user_num); ?></p>
