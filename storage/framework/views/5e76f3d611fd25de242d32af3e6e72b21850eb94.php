...
.oneselsel{line-height:36px;margin-left:100px;flex:1;margin-right:0;display:flex;}
    .oneselsel a{display: block;border:1px solid #ccc;border-radius:3px;margin-right:10px;padding:0 10px;position: relative;font-size:14px;text-align:center;}
    ...
    <div class="layui-form layui-form-pane">
        <div class="layui-form-item">
            <div class="operate_bar">
                <div class="layui-inline btn-group layui-btn-group" style="display:flex;">
                    <!--<button class="layui-btn layui-btn-primary" id="newsAdd" style="float:none;">设置行情</button>-->
                    <div class="oneselsel">
                            <?php $__currentLoopData = $bases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="/admin/myquotation/all?base=<?php echo e($v["name"]); ?>" <?php echo e($base==$v['name']?'class=cur':''); ?>><?php echo e($v["name"]); ?></a>
