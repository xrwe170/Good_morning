                ...
                <div class="layui-form" lay-filter="layuiadmin-form-useradmin" style="padding: 20px 0 0 0;">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <?php if(isset($d['username'])): ?>
                                <input type="text" name="username" value="<?php echo e($d['username']); ?>"
                            ...
                            <input type="hidden" name="user_id" value="<?php echo e(isset($d['user_id'])?$d['user_id']:0); ?>">
                            <input type="hidden" name="agent_id" value="<?php echo e(isset($d['agent_id'])?$d['agent_id']:0); ?>">
                            <input type="hidden" name="id" value="<?php echo e(isset($d['id'])?$d['id']:0); ?>">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <?php if( (!isset($d['id']) || !$d['id']) && isset($d['son_level'])): ?>
                                <button class="layui-btn layui-btn-normal layui-btn-radius"><?php echo e($d['son_level']); ?>级代理商
                                </button>
                            <?php elseif(isset($d['id']) && $d['id']): ?>
                                <button class="layui-btn layui-btn-normal layui-btn-radius"><?php echo e($d['self_info']); ?></button>
                            <?php else: ?>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <script type="text/html" template>
                                <input type="text" name="pro_loss" value="<?php echo e(isset($d['pro_loss']) ? $d['pro_loss'] : 0); ?>"
                        ...
                        <script type="text/html" template>
                            <div class="layui-form-mid layui-word-aux">设置下级代理商的头寸比例，该值不能超过<span
                                        class="layui-badge"><?php echo e(isset($d['max_pro_loss']) ? $d['max_pro_loss'] : 100); ?></span>。如20.85%，则输入20.85
                            </div>
                        </script>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <script type="text/html" template>
                                <input type="text" name="pro_ser" value="<?php echo e(isset($d['pro_ser']) ? $d['pro_ser'] : 0); ?>"
                        ...
                        <script type="text/html" template>
                            <div class="layui-form-mid layui-word-aux">设置下级代理商的手续费比例，该值不能超过<span
                                        class="layui-badge"><?php echo e(isset($d['max_pro_ser']) ? $d['max_pro_ser'] : '100'); ?></span>。如20.85%，则输入20.85
                            </div>
                        </script>
                    </div>
                    ...
                    <div class="layui-form-item" lay-filter="sex">
                        ...
                        <div class="layui-input-block">
                            <?php if(isset($d['is_lock'])): ?>
                            <input type="radio" name="is_lock" value="0"
                                   title="否" <?php echo e(isset($d['is_lock']) && $d['is_lock'] == 0 ? 'checked' : ''); ?> >
                            <input type="radio" name="is_lock" value="1"
                                   title="是"<?php echo e(isset($d['is_lock']) && $d['is_lock'] == 1 ? 'checked' : ''); ?>>
                            <?php else: ?>
                    ...
                    <div class="layui-form-item" lay-filter="sex">
                        ...
                        <div class="layui-input-block">
                            <?php if(isset($d['is_addson'])): ?>
                            <input type="radio" name="is_addson" value="0"
                                   title="禁止" <?php echo e($d['is_addson'] == 0 ? 'checked' : ''); ?> >
                            <input type="radio" name="is_addson" value="1"
                                   title="允许"<?php echo e($d['is_addson'] == 1 ? 'checked' : ''); ?>>
                            <?php else: ?>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        layui.use(['index', 'form', 'upload', 'layer'], function () {
            ...
            /*var jsObject = <?php echo json_encode($d, 15, 512) ?>;
