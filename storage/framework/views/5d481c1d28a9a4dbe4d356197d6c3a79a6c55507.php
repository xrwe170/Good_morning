        ...
        <div class="layui-inline" style="margin-left: 10px;">
          ...
          <div class="layui-input-block">
            <select name="match_id" id="currency_match" class="">
                <option value="-1" class="ww">全部</option>
                <?php $__currentLoopData = $currency_matches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $match): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($match->id); ?>" class="ww"><?php echo e($match->currency_name); ?>/<?php echo e($match->legal_name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
