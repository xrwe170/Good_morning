                ...
                <div class="layui-colla-content layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="category" lay-verify="required">
                               <option value='1' <?php if((isset($currency_match) && $currency_match->category == 1)): ?> selected <?php endif; ?>>主流区</option>
                                <option value='2' <?php if((isset($currency_match) && $currency_match->category == 2)): ?> selected <?php endif; ?>>创新区</option>
                                <option value='3' <?php if((isset($currency_match) && $currency_match->category == 3)): ?> selected <?php endif; ?>>DEFI区</option>
                            </select>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" name="min" placeholder="最小值" value="<?php echo e($currency_match->min ?? 0); ?>" >
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <input type="checkbox" name="open_microtrade" value="1" title="期权" <?php if(isset($currency_match)): ?> <?php echo e($currency_match->open_microtrade == 1 ? 'checked' : ''); ?> <?php else: ?> checked <?php endif; ?>>
                            <input type="checkbox" name="open_coin_trade" value="1" title="币币交易" <?php if(isset($currency_match)): ?> <?php echo e($currency_match->open_coin_trade == 1 ? 'checked' : ''); ?> <?php else: ?> checked <?php endif; ?>>
                            <input type="checkbox" name="coin_trade_success" value="1" title="币币交易撮合开关" <?php if(isset($currency_match)): ?> <?php echo e($currency_match->coin_trade_success == 1 ? 'checked' : ''); ?> <?php else: ?> checked <?php endif; ?>>
