        ...
        <div class="layui-inline" style="margin-left: 50px;">
                ...
                <div class="layui-input-inline">
                    ...
                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>" class="ww"><?php echo e($type); ?></option>
       ...
       <div class="layui-inline" style="margin-left: 50px;">
           ...
           <div class="layui-input-inline">
               <select name="currency_type" id="currency_type" class="layui-input">
                   ...
                   <?php $__currentLoopData = $currency_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <option value="<?php echo e($type['id']); ?>" class="ww"><?php echo e($type['name']); ?></option>
                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               </select>
           </div>
       </div>
                ...
                window.onload = function() {
                    ...
                    layui.use(['element', 'form', 'layer', 'table','laydate'], function () {
                        ...
                        form.on('submit(mobile_search)',function(obj){
                            ...
                            var type = $('#type').val()
                            var sign = $('#sign').val()
                            tbRend("<?php echo e(url('/admin/account/list')); ?>?account="+account
                                +'&type='+type
...
//                                    , {fixed: 'right', title: '操作', width: 150, align: 'center', toolbar: '#barDemo'}
                            ...
                            tbRend("<?php echo e(url('/admin/account/list')); ?>");
                        //监听工具条
                        table.on('tool(accountlist)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                            ...
                            if (layEvent === 'viewDetail') { //编辑
                                var index = layer.open({
                                    title: '查看详情'
                                    , type: 2
                                    , content: '<?php echo e(url('admin/account/viewDetail')); ?>?id=' + data.id
                                    , maxmin: true
                                });
                                layer.full(index);
                            }
