...
<style>
            ...
            <div class="layui-col-md4 layui-col-xs4  layui-col-md4">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input class="layui-input" id="currency" name="currency" lay-verify="required" value="<?php echo e($base); ?>" type="hidden">
                        <div class="oneselsel">
                            <?php $__currentLoopData = $bases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="/admin/user/quotation?base=<?php echo e($v["name"]); ?>" <?php echo e($base==$v['name']?'class=cur':''); ?>><?php echo e($v["name"]); ?></a>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input class="layui-input itime" id="dates" name="dates" lay-verify="required"
                               placeholder="请选择时间" value="<?php echo e($data?substr($data->itime,0,10):date('Y-m-d')); ?>"
                               type="text">
                    </div>
                </div>
            </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select class="layui-input" name="times" id="times" lay-verify="required">
                           <?php for($i=0;$i<=23;$i++): ?>
                                <option <?php echo e($i== intval($data?substr($data->itime,11,2):date('H'))?'selected':''); ?> value="<?php echo e($i); ?>"><?php echo e($i); ?>:00</option>
                            <?php endfor; ?>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input class="layui-input" id="start" name="start" lay-verify="required" placeholder="起始价格"
                               value="<?php echo e($data?$data->close:0.035); ?>" type="text">
                    </div>
                </div>
            </div>
    ...
    <div class="layui-row">
        <button type="button" onclick="previewKLine()" class="layui-btn"><b><?php echo e($base); ?></b> 预生成K线</button>
        <button type="button" onclick="nextKline()" class="layui-btn">保存并生成 <b><?php echo e($base); ?></b> 下一个时间段的数据</button>
    </div>
