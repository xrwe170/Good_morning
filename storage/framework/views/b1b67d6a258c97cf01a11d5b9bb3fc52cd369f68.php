...
<?php $__env->startSection('scripts'); ?>
  ...
  <script src="<?php echo e(URL("/layuiadmin/layui/layui.js")); ?>"></script>
  <script>
    var tixian = '<?php echo e(URL("static/audio/tixian.mp3")); ?>';
    var chuzhi = '<?php echo e(URL("static/audio/chuzhi.mp3")); ?>';
    var qiquan = '<?php echo e(URL("static/audio/qiquantips.mp3")); ?>';
    ...
    setInterval(function () {
      ...
      setTimeout(function (){
        $.ajax({
          ...
          success:function(res){
            if (res.code == 100){
              layer.msg("您有新的期权订单,请及时处理", {time: 3000, shift: 5,offset:"tc"});
              var audio = new Audio(qiquan);
              audio.play();
            }
          }
        });
