...
<?php $__env->startSection('page-content'); ?>
    <button class="layui-btn layui-btn-normal layui-btn-radius" onclick="layer_show('添加NFT','<?php echo e(url('admin/bind_box/add')); ?>')">添加NFT</button>
    ...
    <script>
        ...
        layui.use(['element', 'form', 'layer', 'table'], function () {
            ...
            var bindlist = table.render({
                ...
                elem: '#bindlist'
                ,url: '<?php echo e(url('admin/bind_box/list')); ?>' //数据接口
                ,page: true //开启分页
                ,limit: 20
            ...
            table.on('tool(bindlist)', function(obj){
                ...
                if (layEvent === 'edit') {
                    var index = layer.open({
                        title: '编辑'
                        ,type: 2
                        ,content: '<?php echo e(url('/admin/bind_box/edit')); ?>?id=' + data.id
                        ,area: ['960px', '600px']
                    });
                }
                if(layEvent === 'del'){
