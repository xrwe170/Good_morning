			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<select name="lang" class="" lay-filter="lang" lay-verify="required">
						<?php $__currentLoopData = $langList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang=>$langtxt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				        <option value="<?php echo e($lang); ?>" <?php echo e(isset($news['lang']) && $news['lang'] == $lang ? 'selected' : ''); ?>><?php echo e($langtxt); ?></option>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				    </select>
				</div>
			</div>
