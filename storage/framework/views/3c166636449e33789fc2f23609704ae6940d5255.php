...
<?php $__env->startSection('page-content'); ?>
    <div style="margin-top: 10px;width: 100%;">
        ...
        <button class="layui-btn layui-btn-normal" style="margin-left: 10px;" onclick="javascrtpt:window.location.href='<?php echo e(url('/admin/feedback/csv')); ?>'">导出用户</button>
    </div>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        layui.use(['table','form'], function(){
            ...
            table.render({
                elem: '#demo'
                ,url: "<?php echo e(url('admin/feedback/list')); ?>" //数据接口
                ,page: true //开启分页
                ,id:'mobileSearch'
                ,cols: [[ //表头
            ...
            table.on('tool(test)', function(obj){
                ...
                if(obj.event === 'del'){
                    layer.confirm('真的删除行么', function(index){
                        $.ajax({
                            url:"<?php echo e(url('admin/feedback/del')); ?>",
                            type:'get',
                            dataType:'json',
                            data:{id:data.id},
                            success:function (res) {
                    ...
                    layer_show('编辑承兑商','<?php echo e(url('admin/feedback/detail')); ?>?id='+data.id);
                } else if(obj.event === 'detail'){
                    layer_show('查看详情','<?php echo e(url('admin/feedback/detail')); ?>?id='+data.id,800,600);
                }
            });
