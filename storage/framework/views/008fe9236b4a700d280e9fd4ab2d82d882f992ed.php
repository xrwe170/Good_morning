    ...
    <form class="layui-form" action="">
        <div class="layui-tab">
            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <input type="checkbox" name="is_micro" title="期权交易" value="1" lay-filter="microtrade" lay-skin="primary" <?php if($result->is_micro ==1): ?> checked <?php endif; ?>>
                ...
                <div class="layui-tab-item">
                    <div class="layui-form-item <?php echo e($result->id == 3 ? '' : 'hide'); ?>">
                        <label class="layui-form-label">充币地址trc20</label>
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="address_omni" name="address_omni" value="<?php echo e($result->address_omni); ?>" placeholder="地址">
                        </div>
                    </div>
                     <?php if( $result->id ==3): ?>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="address_erc" name="address_erc" value="<?php echo e($result->address_erc); ?>" placeholder="地址">
                        </div>
                    </div>
                    <?php endif; ?>
                      <?php if( $result->id !=3): ?>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select name="type" lay-verify="required">
                                <option value="btc" <?php if($result->type =='btc'): ?> selected <?php endif; ?>>BTC</option>
                                <option value="usdt" <?php if($result->type =='usdt'): ?> selected <?php endif; ?>>USDT</option>
                                <option value="eth" <?php if($result->type =='eth'): ?> selected <?php endif; ?>>ETH</option>
                                <option value="erc20" <?php if($result->type =='erc20'): ?> selected <?php endif; ?>>ERC20</option>
                                <option value="xrp" <?php if($result->type =='xrp'): ?> selected <?php endif; ?>>XRP</option>
                            </select>
                        </div>
