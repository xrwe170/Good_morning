...
<div class="layui-form">
    <button class="layui-btn layui-btn-normal layui-btn-radius" onclick="layer_show('添加双币项目','<?php echo e(url('admin/dual/add')); ?>')">添加双币项目</button>
    
    <!--搜索-->
    <div class="layui-inline">
        <!--<input name="user_id" type="hidden" value="<?php echo e(Request::get('user_id')); ?>">-->
    ...
    <script>
        layui.use(['table','form'], function(){
            ...
            var demo = table.render({
                elem: '#demo'
                ,toolbar: '#toolbar'
                ,url: '<?php echo e(url('admin/dual_list')); ?>' //数据接口
                ,page: true //开启分页
                ,id:'mobileSearch'
                ,cols: [[ //表头
            ...
            table.on('tool(test)', function (obj) {
                ...
                if (layEvent === 'edit') {
                    ...
                    var index = layer.open({
                        title: '编辑'
                        ,type: 2
                        ,content: '<?php echo e(url('/admin/dual/editDualView')); ?>?id=' + data.id
                        ,area: ['960px', '500px']
                    });
                }
                
                // if(obj.event === 'edit'){
                //     layer_show('编辑双币项目','<?php echo e(url('admin/dual/editDualView')); ?>?id='+data.id);
                // }
            });
        ...
        //     });
            ...
            //     var id = this.value;
            //     $.ajax({
            //         url:'<?php echo e(url('admin/is_transfer')); ?>',
            //         type:'post',
            //         dataType:'json',
            //         data:{id:id},
            //         success:function (res) {
