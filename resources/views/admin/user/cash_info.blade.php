...
@section('page-content')
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="iban" autocomplete="off" class="layui-input" value="{{$cashInfo->iban ?? ''}}">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">银行编码（BIC/SWIFT)</label>
            <div class="layui-input-block">
                <input type="text" name="bank_code" autocomplete="off" class="layui-input" value="{{$cashInfo->bank_code ?? ''}}">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">银行地址</label>
            <div class="layui-input-block">
                <input type="text" name="bank_address" autocomplete="off" class="layui-input" value="{{$cashInfo->bank_address ?? ''}}">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
