 ...
 */
  ...
  */
  function SetLanguage($langcode = 'en', $lang_path = 'language/') {
    ...
    $PHPMAILER_LANG = array(
      'authenticate'         => 'SMTP Error: SMTP无法验证.',
      'connect_host'         => 'SMTP Error: 不能连接到SMTP主机.',
      'data_not_accepted'    => 'SMTP Error: 不接受数据',
  ...
  */
  ...
  public function MsgHTML($message, $basedir = '') {
    ...
    if (empty($this->AltBody)) {
      $this->AltBody = '请使用HTML兼容的电子邮件查看器!!' . "\n\n";
    }
    return $message;
  }
